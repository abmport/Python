...
A classe Episodio possui o número do episódio, o número da tempora a qual
o episódio pertence, o nome do episódio e a sua duração em minutos.
O construtor do Episodio deve inicializar os seus atributos.

A classe Serie possui o nome da serie e uma lista de episódios.
O construtor da Serie deve inicializar os seus atributos e a lista de
episodios como vazia.
A classe Serie deve possuir o método inserir_episodio, que insere um episódio
na lista de episódios.
A classe Serie deve possuir o método buscar_episodios, que retorna a lista
com todos os episódios de uma determinada temporada da série.
'''
